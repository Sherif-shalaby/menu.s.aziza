...
{{--<div class="w-full flex flex-row bg-center bg-no-repeat bg-cover text-center items-center"
    style="height: 200px; background-image: url('@if (!empty(session('home_background_image'))) {{ asset('uploads/' . session('home_background_image')) }}
        ...
        <div class="header-cart-title flex-w flex-sb-m ">
            <span class="mtext-103 cl2">
                <a href="{{ action('HomeController@index') }}" >
                    <img src="{{ asset('uploads/' . session('logo')) }}" alt="IMG-LOGO" style="height: 100px;">
                </a>
            </span>
