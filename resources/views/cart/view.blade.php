...
<div class="container mx-auto mt-14">
    <div class="flex mt-40 cart-bg rounded-md">
...
<div class="container mx-auto py-4">
    ...
    <div class="flex lg:flex-row xs:flex-col py-4 cart-bg rounded-md opacity-80 row ">
        <div class="col-md-6 xl:px-16 lg:px-2 md:px-4 xs:px-4 flow-root">
            <div class="form-group">
                ...
                <textarea class="c-f-s border-b border-dark rounded-lg w-full px-4" name="sales_note" id="sales_note"
                    rows="3"></textarea>
            </div>
            <div class="flex flex-row py-2 flow-root">
                ...
                <input type="text" name="customer_name" required
                    class="c-f-s border-b border-dark rounded-lg w-full px-4 w-3/5 @if ($locale_direction == 'rtl') float-left @else float-right @endif "
                    value="">
            </div>
            {{-- <div class="flex flex-row py-2 flow-root">
                <label
            ...
            <div class="flex flex-row justify-center order_later_div hidden  row">
                <div class="flex flex-row col-md-8" style="margin-top: 10px;">
                    ...
                    <select id="month" name="month"
                        class="font-select w-32 mx-2 border border-gray-300 cl5 md:text-base xs:text-xs rounded-lg focus:ring-blue-500 focus:bg12 border-blue-500 block w-full md:p-2.5 xs:p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:bg12 border-blue-500">
                ...
                <div class="col-md-4 col-6" style="display: inline-flex;margin-top: 10px;">
                    ...
                    <input type="time" name="time" id="base-input" value="{{ date('H:i') }}"
                        class="font-select w-32 border border-gray-300 cl5 md:text-base xs:text-xs rounded-lg focus:ring-blue-500 focus:bg12 border-blue-500 block w-full py-2.5 px-0 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:bg12 border-blue-500">
                </div>
            </div>
            ...
            <div class="flex flex-row justify-center inside_restaurant_div hidden ">
                ...
                <select id="table_no" name="table_no"
                    class="w-1/4 mx-2 border border-gray-300 cl5 text-sm rounded-lg focus:ring-blue-500 focus:bg12 border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:bg12 border-blue-500">
                ...
                <div class="flex @if ($locale_direction == 'rtl') flex-row-reverse @else flex-row @endif ">
                    ...
                    <div class="w-1/2 @if ($locale_direction == 'rtl') text-right @else text-left @endif">
                        <h3 class="font-semibold text-lg text-white">
                            {{$item->attributes->size?$item->attributes->size:'' }}</h3>
                    </div>
                ...
                <div class="flex @if ($locale_direction == 'rtl') flex-row-reverse @else flex-row @endif ">
                    ...
                    {{-- <div class="flex-1">
                        <div
                            ...
                            <input type="radio" data-id="{{ $item->id }}" @if ($item->attributes->variation_id ==
                            $variation->id) checked @endif
                            value="{{ $variation->id }}"
                            class="variation_radio w-4 h-4 border-red focus:ring-2 focus:ring-red dark:focus:ring-red
                            dark:focus:bg11 dark:bg-gray-700 dark:border-red"
                            aria-labelledby="radio" aria-describedby="radio">
                            <label for="radio" class="block ml-2 text-sm font-medium cl5 dark:text-gray-300 px-2">
                ...
                <div class="flex @if ($locale_direction == 'rtl') flex-row-reverse @else flex-row @endif py-2">
                    <div class="flex-1">
                        <div class="flex @if ($locale_direction == 'rtl') flex-row-reverse @else flex-row @endif">
                            ...
                            class="extra_checkbox form-check-input appearance-none h-4 w-4 border border-red rounded-sm
                            bg-white checked:bg11 checked:border-red focus:outline-none transition duration-200 mt-1
