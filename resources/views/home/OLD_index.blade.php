    ...
    <div class="flex flex-row navigation">
        ...
        <div class="categories">
            <div class=" width-fit h-10 bg-red text-white mx-auto text-center md:text-base xs:text-sm   rounded-xl ">
                <div class="dropdown">
                    <button class="dropbtn text-2xl text-white font-semibold py-1 ">@lang('lang.categories') <i
        ...
        <div class="text-white  font-bold text-right w-48 about">
            <div class="dropdown">
                <a class="dropbtn bg-red text-white md:text-base xs:text-sm font-bold px-4 py-2 border-2 border-white rounded-lg"
                    href="{{ action('AboutUsController@index') }}"> @lang('lang.about_us') <i
        ...
        <div class="flex-1 w-80">
            <div class="category-slider">
                ...
                <div class="text-center md:w-1/4 xs:w-1/3 xl:p-8 lg:p-2 md:p-2 xs:p-1">
                    <a href="{{ action('ProductController@getProductListByCategory', $category->id) }}" class="">
